...
#'@param elected "Array of representatives elected in previously analyzed costituencies"
#'@param counter "Counter of total parliament seats for each party in previously analyzed costituencies"
#'@return The updated array of elected representatives
#'@return Updated counter of total parliament seats
#'@export
majority = function(elected, counter){
...
#4. updates the array of elected representatives
elected=c(elected,as.character(winner))

#5. updates the counter of seats
...
#'@param counter "Counter of total parliament seats won by each party in previously analyzed costituencies"
